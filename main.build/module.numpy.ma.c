...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "numpy.ma", 27);
...
void checkModuleConstants_numpy$ma(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "numpy.ma", 27);
}
#endif

// The module code objects.
static PyCodeObject *codeobj_6fb3362944128277cf97756233107576;

static void createModuleCodeObjects(void) {
    module_filename_obj = mod_consts[2]; CHECK_OBJECT(module_filename_obj);
    codeobj_6fb3362944128277cf97756233107576 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[26], NULL, NULL, 0, 0, 0);
}
...
NUITKA_MAY_BE_UNUSED static char const *module_full_name = "numpy.ma";
...
PyObject *modulecode_numpy$ma(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    ...
    if (_init_done) {
#ifdef _NUITKA_TRACE
        PRINT_STRING("numpy.ma: Skipping module init, already done.\n");
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_6fb3362944128277cf97756233107576;
    ...
    // Frame without reuse.
    frame_6fb3362944128277cf97756233107576 = MAKE_MODULE_FRAME(codeobj_6fb3362944128277cf97756233107576, module_numpy$ma);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_6fb3362944128277cf97756233107576);
    assert(Py_REFCNT(frame_6fb3362944128277cf97756233107576) == 2);
    ...
    }
    {
        ...
        frame_6fb3362944128277cf97756233107576->m_frame.f_lineno = 42;
    ...
    }
    {
        ...
        frame_6fb3362944128277cf97756233107576->m_frame.f_lineno = 43;
    ...
    }
    {
        ...
        frame_6fb3362944128277cf97756233107576->m_frame.f_lineno = 45;
    ...
    }
    {
        ...
        frame_6fb3362944128277cf97756233107576->m_frame.f_lineno = 46;
    ...
    }
    {
        ...
        frame_6fb3362944128277cf97756233107576->m_frame.f_lineno = 52;
    ...
    }
    {
        ...
        frame_6fb3362944128277cf97756233107576->m_frame.f_lineno = 53;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_6fb3362944128277cf97756233107576);
#endif
    popFrameStack();

    assertFrameObject(frame_6fb3362944128277cf97756233107576);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_6fb3362944128277cf97756233107576, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_6fb3362944128277cf97756233107576->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_6fb3362944128277cf97756233107576, exception_lineno);
    }
